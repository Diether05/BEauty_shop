...
if (isset($_SESSION["uid"])) {
    ...
    $cardnumberstr=mysqli_real_escape_string($con,(string)$cardnumber);
    $total_count=mysqli_real_escape_string($con,$_POST['total_count']);
    $prod_total = mysqli_real_escape_string($con,$_POST['total_price']);
